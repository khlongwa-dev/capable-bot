...
function TopicCard({ topic }) {
  ...
  return (
    ...
    >
      ...
      >
        <span
          className="inline-block text-xs font-medium tracking-widest uppercase px-2 py-1 rounded mb-3"
        ...
        <h2
          ...
          style={{ color: "#f0eee8", fontFamily: "'Syne', sans-serif" }}
        >
          {topic.title}
        </h2>
        <p
          className="text-sm leading-relaxed whitespace-pre-line pb-4"
          style={{ color: "#8a8899", fontFamily: "'DM Sans', sans-serif" }}
        >
          {topic.description}
        </p>
      </div>
      ...
      >
        <a
          ...
          className="flex items-center gap-1 text-sm font-medium group transition-all duration-200"
          style={{ color: topic.color, fontFamily: "'DM Sans', sans-serif" }}
        >
          Read more
          <svg className="transition-transform duration-200 group-hover:translate-x-1" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
...
function CapableBot() {
  ...
  const sendMessage = (text) => {
    ...
    // Placeholder — replace with your Zapier webhook call later
    setTimeout(() => {
      setMessages(prev => [
        ...prev,
  ...
  return (
    <>
      ...
      <button
        ...
        className="capable-pulse fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full flex items-center justify-center transition-transform duration-200 hover:scale-110 focus:outline-none"
      ...
      {open && (
        ...
        >
          <div
            className="modal-in flex flex-col rounded-2xl overflow-hidden w-full"
            style={{
              maxWidth: "480px",
          ...
          >
            ...
            >
              ...
              <div>
                <p className="font-bold text-sm" style={{ color: "#f0eee8", fontFamily: "'Syne', sans-serif" }}>Capable</p>
                <p className="text-xs" style={{ color: "#2dd4bf" }}>● Online · Data Science Assistant</p>
              </div>
              <button
                onClick={() => setOpen(false)}
                className="ml-auto text-sm px-2 py-1 rounded-lg transition-colors duration-150"
                style={{ color: "#8a8899" }}
                onMouseEnter={e => { e.currentTarget.style.color = "#f0eee8"; e.currentTarget.style.background = "rgba(255,255,255,0.06)"; }}
                onMouseLeave={e => { e.currentTarget.style.color = "#8a8899"; e.currentTarget.style.background = "transparent"; }}
              >
                ✕
              </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4 flex flex-col gap-3">
              {messages.map((msg, i) => (
                <div
                  key={i}
                  className="msg-in max-w-xs px-4 py-2 text-sm leading-relaxed"
                  style={{
            ...
            {/* Input */}
            <div
              className="px-4 pb-4 pt-3 flex gap-2 flex-shrink-0 border-t"
              style={{ borderColor: "rgba(255,255,255,0.07)" }}
            >
              <input
                type="text"
                ...
                className="flex-1 rounded-xl px-4 py-2 text-sm outline-none transition-colors duration-200"
                style={{
                  background: "#1c1c26",
              ...
              <button
                onClick={() => sendMessage()}
                className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 transition-all duration-200 hover:scale-105"
...
export default function App() {
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a0f" }}>
      ...
      <header style={{ width: "100%", paddingTop: "72px", paddingBottom: "48px" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 32px", textAlign: "center" }}>
          ...
          <h1 style={{
            ...
            marginBottom: "24px", margin: "0 auto 24px auto", maxWidth: "900px"
          }}>
            Explore{" "}
            <span style={{
          ...
          <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "12px" }}>
            {[
              ...
              <div key={label} style={{
                ...
                <p style={{ fontSize: "13px", fontWeight: 500, color: "#f0eee8", fontFamily: "'Syne', sans-serif" }}>{value}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── CARDS GRID ── */}
      <main style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 32px 120px 32px" }}>
        <div style={{
          display: "grid",
